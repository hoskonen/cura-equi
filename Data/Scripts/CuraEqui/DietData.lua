...
-- local DietData = {
--   -- NEW staples (add your real GUIDs)
-- NEW staples
-- ["3e2f9a64-8c2b-4f7a-a9d3-5c1b2e7d4f90"] = { token = "hay_bundle", nutrition = 35 },
...
--   ["3bebc0b5-dcf8-4449-b37a-a5a362995826"] = { token = "leek",          nutrition = 0  },
--   ["4a6fa310-067a-404d-9813-bd1761d1c70d"] = { token = "onion",         nutrition = 0  },
--   ["4088cfbd-c7cc-46ba-9e68-8db8815932e3"] = { token = "onioncooked",   nutrition = 0  },
--   ["5dceabb5-aef0-4bf5-b401-acbc30a44e21"] = { token = "garlic",        nutrition = 0  },
--   ["5f02ef0d-0551-44b1-902c-c96a8650d01d"] = { token = "garliccooked",  nutrition = 0  },
--   ["e19d0a82-e5cc-49b2-b0a2-14b004cb4717"] = { token = "horseradish",   nutrition = 0  },
--   ["907a2cd5-2730-424e-bf11-ef1f2db8f7e1"] = { token = "horseradishcooked", nutrition = 0 },
--   ["220fd40a-3990-4a34-b6de-eb4a6451539b"] = { token = "sauerkraut",    nutrition = 0  },
-- }
-- return DietData
